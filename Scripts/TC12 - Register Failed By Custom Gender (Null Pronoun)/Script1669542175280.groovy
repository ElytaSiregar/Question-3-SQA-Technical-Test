...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Sign up for Facebook  Facebook/input_concat(We couldn, , t create your acc_7f0a99'), 
    '7VNR8DdcCqniG5+0sAjNHg==')
...
WebUI.click(findTestObject('Page_Sign up for Facebook  Facebook/label_Custom'))

WebUI.setText(findTestObject('Page_Sign up for Facebook  Facebook/input_Your pronoun is visible to everyone_c_a78fbb'), 
    'Mix')
